    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <button type="button" class="bg-blue tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-sm tw-w-full"
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="tw-dw-btn tw-dw-btn-primary tw-dw-btn-md bg-olive tw-text-white" id="pos-save">@lang('sale.finalize_payment')</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
<div class="modal fade" tabindex="-1" role="dialog" id="card_details_modal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="tw-dw-btn tw-dw-btn-primary tw-dw-btn-md bg-olive tw-text-white" id="pos-save-card">@lang('sale.finalize_payment')</button>
            </div>
        </div>
    </div>
</div>
