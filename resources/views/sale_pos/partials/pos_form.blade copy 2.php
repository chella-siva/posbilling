	...
	<div class="col-sm-12 pos_product_div">
		...
		<table class="table table-condensed table-bordered table-striped table-responsive" id="pos_table">
			<thead class="tw-bg-sky-800 tw-text-sm tw-font-medium tw-text-white">
				<tr>
					<th class="tex-center tw-text-sm md:!tw-text-base tw-font-medium @if(!empty($pos_settings['inline_service_staff'])) width-30 @else width-35 @endif">	
						@lang('sale.product') @show_tooltip(__('lang_v1.tooltip_sell_product_column'))
					</th>
					<th class="text-center tw-text-sm md:!tw-text-base tw-font-medium width-18">
						@lang('sale.qty')
					</th>
					@if(!empty($pos_settings['inline_service_staff']))
						<th class="text-center tw-text-sm md:!tw-text-base tw-font-medium width-15">
							@lang('restaurant.service_staff')
						</th>
					@endif
					<th class="text-center tw-text-sm md:!tw-text-base tw-font-medium width-15 {{$hide_tax}} min_width">
						@lang('sale.price_inc_tax')
					</th>
					<th class="text-center tw-text-sm md:!tw-text-base tw-font-medium width-12 min_width">
					MRP
					</th>
					<th class="text-center tw-text-sm md:!tw-text-base tw-font-medium width-15 min_width">
						@lang('sale.subtotal')
					</th>
					<th class="text-center width-5"><i class="fas fa-times tw-text-sm md:!tw-text-base tw-font-medium " aria-hidden="true"></i></th>
				</tr>
			</thead>
			<tbody></tbody>
		</table>
