                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="box box-solid bg-blue">
                            <div class="box-body">
<!-- 
                                <div class="row border-custom-bottom">
                                    <div class="">
                                        <span class="col-md-4 text-left">@lang('lang_v1.total_items'):</span>
                                        <span class="col-md-8 text-right text-bold lead total_quantity">0</span>
                                    </div>
                                </div>                 -->
