	...
	<div class="col-sm-12 pos_product_div">
		...
		<table class="table table-condensed table-bordered table-striped table-responsive" id="pos_table">
			<thead class="tw-items-center tw-justify-center tw-w-full tw-border-r tw-h-5 tw-bg-orange-800 tw-shrink-0 tw-border-primary-500/30">
				<tr>
					<th class="tex-center @if(!empty($pos_settings['inline_service_staff'])) width-30 @else width-35 @endif">	
					...
					<th class="text-center width-5"><i class="fas fa-times" aria-hidden="true"></i></th>
				</tr>
			</thead>
			<tbody>
