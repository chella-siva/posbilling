	...
	<div class="col-md-6 invoice-col width-50">
		<table class="table-no-side-cell-border table-no-top-cell-border width-100 table-slim">
			<tbody>
				...
				<!-- Total -->
				<tr>
					<th style="background-color: #357ca5 !important; color: white !important" class="font-20 padding-10">
						{!! $receipt_details->total_label !!}
					</th>
					<td class="text-right font-20 padding-10" style="background-color: #357ca5 !important; color: white !important">
