    ...
    <div class="box-body">
      ...
      <div class="col-sm-3">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>{!! Form::checkbox('show_email', 1, $invoice_layout->show_email, ['class' => 'input-icheck']); !!} @lang('invoice.show_email')</label>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>{!! Form::checkbox('show_website', 1, $invoice_layout->show_website, ['class' => 'input-icheck']); !!} Website</label>               
            </div>
          </div>
        </div>
    ...
    <div class="box-body">
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>{!! Form::checkbox('show_mrp', 1, $invoice_layout->show_mrp, ['class' => 'input-icheck']); !!} Show MRP</label>
            </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>{!! Form::checkbox('show_tax', 1, $invoice_layout->show_tax, ['class' => 'input-icheck']); !!} Show Tax</label>
            </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>{!! Form::checkbox('show_unit', 1, $invoice_layout->show_unit, ['class' => 'input-icheck']); !!} Show Unit</label>
            </div>
          </div>
        </div>
         ...
         <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>{!! Form::checkbox('show_savedvalue', 1, $invoice_layout->show_savedvalue, ['class' => 'input-icheck']); !!} Show Saved value</label>
            </div>
          </div>
        </div>
          ...
          <div class="form-group">
            ...
            {!! Form::text('savedvalue_lable', $invoice_layout->savedvalue_lable, ['class' => 'form-control', 'placeholder' => 'Savedvalue label' ]); !!}
          </div>
        </div>
         ...
         <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>{!! Form::checkbox('show_signature', 1, $invoice_layout->show_signature, ['class' => 'input-icheck']); !!} Show Signature</label>
            </div>
          </div>
        </div>
       ...
       <div class="col-sm-3">
        <div class="form-group">
            ...
            @if(!empty($invoice_layout->signature_image))
                <br>
                <img src="{{ asset('uploads/signature_image/' . $invoice_layout->signature_image) }}" 
  ...
  <div class="box box-solid">
    <div class="box-body">
      <div class="row">
        ...
        <div class="col-sm-4 @if($invoice_layout->design != 'slim') hide @endif" id="hide_price_div">
          <div class="form-group">
            <div class="checkbox">
              <label>
