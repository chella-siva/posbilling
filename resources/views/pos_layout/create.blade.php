...
{!! Form::open(['url' => action([\App\Http\Controllers\PosLayoutController::class, 'store']), 'method' => 'post', 'id' => 'add_pos_layout_form', 'files' => true]) !!}
    ...
    <div class="row hide-for-letterhead">
      ...
      <div class="col-sm-3">
        ...
        <div class="col-sm-3">
          <div class="form-group">
              <div class="checkbox">
                <label>{!! Form::checkbox('show_website', 1, false, ['class' => 'input-icheck']); !!} website</label>
              </div>
          </div>
        </div>
        <div class="col-sm-12">
    ...
    <div class="box-body">
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="form-group">
              <div class="checkbox">
                <label>{!! Form::checkbox('show_mrp', 1, false, ['class' => 'input-icheck']); !!} Show MRP</label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
              <div class="checkbox">
                <label>{!! Form::checkbox('show_tax', 1, false, ['class' => 'input-icheck']); !!} Show tax</label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
              <div class="checkbox">
                <label>{!! Form::checkbox('show_unit', 1, false, ['class' => 'input-icheck']); !!} Show Unit</label>
              </div>
          </div>
        </div>
        ...
        <div class="col-sm-3">
          <div class="form-group">
              <div class="checkbox">
                <label>{!! Form::checkbox('show_savedvalue', 1, false, ['class' => 'input-icheck']); !!} Show Saved Value</label>
              </div>
          </div>
        </div>
         ...
         <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('table_qty_label','Saved Value Label' . ':' ) !!}
            {!! Form::text('savedvalue_lable','Saved Value Label', ['class' => 'form-control',
              'placeholder' => 'Saved Value Label' ]); !!}
          </div>
        </div>
  ...
  <div class="box box-solid">
    <div class="box-body">
      <div class="row">
        ...
        <div class="col-sm-4 hide" id="hide_price_div">
          <div class="form-group">
            <div class="checkbox">
              <label>
