    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $input = $request->only(['name', 'header_text',
                ...
                'table_product_label', 'table_qty_label', 'table_unit_price_label','show_savedvalue','savedvalue_lable','show_signature','signature_image',
            ...
            $checkboxes = ['show_business_name', 'show_location_name', 'show_landmark', 'show_city', 'show_state', 'show_country', 'show_zip_code', 'show_mobile_number', 'show_alternate_number', 'show_email', 'show_tax_1', 'show_tax_2', 'show_logo', 'show_barcode', 'show_payments', 'show_customer', 'show_client_id','show_savedvalue',
                'show_brand', 'show_sku', 'show_cat_code', 'show_sale_description', 'show_sales_person', 'show_expiry','show_signature',
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $input = $request->only(['name', 'header_text',
                ...
                'sales_person_label', 'prev_bal_label', 'opening_bal_label', 'show_opening_bal','show_mrp','show_tax','show_unit','show_website','date_time_format', 'show_savedvalue','savedvalue_lable','change_return_label', 'round_off_label', 'commission_agent_label', ]);
            $business_id = $request->session()->get('user.business_id');
            $checkboxes = ['show_business_name', 'show_location_name', 'show_landmark', 'show_city', 'show_state', 'show_country', 'show_zip_code', 'show_mobile_number', 'show_alternate_number', 'show_email', 'show_tax_1', 'show_tax_2', 'show_logo', 'show_barcode', 'show_payments', 'show_customer', 'show_client_id',
                ...
                'show_qr_code', 'show_commission_agent', 'show_letter_head','show_savedvalue'];
            foreach ($checkboxes as $name) {
                $input[$name] = ! empty($request->input($name)) ? 1 : 0;
            }
